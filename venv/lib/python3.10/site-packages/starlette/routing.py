...
class Mount(BaseRoute):
    def __init__(
        ...
        *,
        ...
        ), "Either 'app=...', or 'api=' must be specified"
    ...
    def routes(self) -> list[BaseRoute]:
        return getattr(self._base_app, "api", [])
...
class Router:
    ...
    def route(
        ...
        >>> api = [Route(path, endpoint=...), ...]
        >>> app = Starlette(api=api)
        """
        warnings.warn(
    ...
    def websocket_route(self, path: str, name: str | None = None) -> typing.Callable:  # type: ignore[type-arg]
        ...
        >>> api = [WebSocketRoute(path, endpoint=...), ...]
        >>> app = Starlette(api=api)
        """
        warnings.warn(
